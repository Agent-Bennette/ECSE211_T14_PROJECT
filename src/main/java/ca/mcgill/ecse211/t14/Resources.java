...
public class Resources {
  ...
  public static final float[][] RGB_AVERAGES_OF_COLOURS = { 
      { 0.018f, 0.078f, 0.085f }, // Blue's RGB mean, obtained
      // on a blue whiteout
      // dispenser
  ...
  public static final float[][] RGB_VARIANCES_OF_COLOURS = { 
      {0.004f, 0.018f, 0.013f }, // Blue's RGB variance,
      // obtained on a blue
      // whiteout dispenser
   ...
   *    There should only ever been one referenced passed for each sensor, each thread, and
   *    each data encapsulation instance. References between threads should be accomplished
   *    only through the use of references provided here in this section in the Resources
   *    file.
   *    Further note that as these threads have sleep periods, their constants are also put
   *    in this section of resources.
   * 
   * =======================================================================================
   */
