...
public class Map
{
  ...
  public Map(float aStartingArea_UR_x, float aStartingArea_UR_y, float aStartingArea_LL_x, float aStartingArea_LL_y, float aBridgeArea_UR_x, float aBridgeArea_UR_y, float aBridgeArea_LL_x, float aBridgeArea_LL_y, float aSearchArea_UR_x, float aSearchArea_UR_y, float aSearchArea_LL_x, float aSearchArea_LL_y)
  {
  ...
  public String toString()
  {
    return super.toString() + "["+
            "startingArea_UR_x" + ":" + getStartingArea_UR_x()+ "," +
            "startingArea_UR_y" + ":" + getStartingArea_UR_y()+ "," +
            "startingArea_LL_x" + ":" + getStartingArea_LL_x()+ "," +
            "startingArea_LL_y" + ":" + getStartingArea_LL_y()+ "," +
            "bridgeArea_UR_x" + ":" + getBridgeArea_UR_x()+ "," +
            "bridgeArea_UR_y" + ":" + getBridgeArea_UR_y()+ "," +
            "bridgeArea_LL_x" + ":" + getBridgeArea_LL_x()+ "," +
            "bridgeArea_LL_y" + ":" + getBridgeArea_LL_y()+ "," +
            "searchArea_UR_x" + ":" + getSearchArea_UR_x()+ "," +
            "searchArea_UR_y" + ":" + getSearchArea_UR_y()+ "," +
            "searchArea_LL_x" + ":" + getSearchArea_LL_x()+ "," +
            "searchArea_LL_y" + ":" + getSearchArea_LL_y()+ "]";
  }
}