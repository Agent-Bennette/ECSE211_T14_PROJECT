...
/**
 * Contains methods which execute algorithms that localize the robot and correct odometer values accordingly.
...
public class Localizer
{
  ...
  /**
   * Executes to-intersection-of-lines localization.
   * Assumption: The robot does not veer off the course so much that the robot's assumption that
   * it is near an intersection is true.
   * Assumption: The robot's orientation is at an error of less than 15 degrees plus or minus.
   * 
